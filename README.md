...
| Detect & cancel duplicates | Five layers: exact content fingerprint, fuzzy field match, **OCR text-overlap match (catches crops / re-shoots)**, exact image hash, and perceptual image hash; returns `Rejected.Duplicate`. |
